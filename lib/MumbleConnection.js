 ...
 * @param Users Users
 **/
var MumbleConnection = function (socket, Users) {
    var self = this;
...
MumbleConnection.prototype._onUDPTunnel = function( data ) {
    ...
    var sessionId = util.toVarint( this.sessionId );

    // Client side voice header.
    var voiceHeader = new Buffer( 1 + sequenceVarint.length + sessionId.length);
